...
@Slf4j
@Service
public class TwofishKeyRotationService implements KeyRotationService {
    ...
    public void init() {
        ...
        log.info("Twofish key rotation service initialized successfully.");
    }

    private SecretKey decodeKey(String base64Key) {
        byte[] decodedKey = Base64.getDecoder().decode(base64Key);
        return new SecretKeySpec(decodedKey, "Twofish");
    }
    ...
    public KeyRotationType getType() {
        return KeyRotationType.TWOFISH;
    }
    ...
    private String encrypt(String data) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, newKey, new javax.crypto.spec.IvParameterSpec(iv));
    ...
    private String decrypt(String encryptedData) throws Exception {
        ...
        cipher.init(Cipher.DECRYPT_MODE, oldKey, new javax.crypto.spec.IvParameterSpec(iv));
