...
@Component
@ConditionalOnProperty(name = "n1netails.hashing.sha-512.enabled", havingValue = "true", matchIfMissing = true)
public class Sha512Strategy implements HashingStrategy {
